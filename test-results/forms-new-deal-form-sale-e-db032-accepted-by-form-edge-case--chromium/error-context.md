...
- Name: forms.spec.ts >> new deal form >> sale end date in the past is still accepted by form (edge case)
- Location: tests/forms.spec.ts:32:3
...
Call log:
  - waiting for getByRole('button', { name: /select date/i })
