...
const GROUP_COLOURS: Record<string, { idle: string; active: string }> = {
  ...
  "Business & Finance":  { idle: "border-amber-200 text-amber-600 hover:bg-amber-50 dark:border-amber-800 dark:text-amber-400 dark:hover:bg-amber-950", active: "bg-amber-500 border-amber-500 text-white dark:bg-amber-500 dark:border-amber-500" },
